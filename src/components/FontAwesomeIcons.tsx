...
export const NetworkDeviceIcon = () => <i className="fa-solid fa-server"></i>

export const ServerIcon = () => <i className="fa-solid fa-hard-drive"></i>
...
// export const UploadIcon = () => <i className='' className="fa-solid fa-upload" />
